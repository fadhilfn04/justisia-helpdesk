            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                ...
                <div class="d-flex flex-column flex-center py-10 py-lg-20 px-5 px-md-15 w-100 bg-overlay bg-opacity-50">
                    ...
                    <a href="{{ route('dashboard') }}" class="mb-12">
                        <img alt="Logo" src="{{ image('logos/justisia-logo.svg') }}" class="h-60px h-lg-80px"/>
                    </a>
                    <!--end::Logo-->

                    <!--begin::Illustration-->
                    <img class="d-none d-lg-block mx-auto w-300px w-md-50 w-xl-500px mb-10 mb-lg-15"
                        src="{{ image('misc/justice-illustration.svg') }}" alt="Justisia Illustration"/>
                    <!--end::Illustration-->
